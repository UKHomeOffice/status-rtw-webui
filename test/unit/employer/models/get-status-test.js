const ThisModel = require('../../../../apps/employer/models/get-status');
...
describe('apps/employer/models/get-status', () => {
  describe('.prepare', () => {
  ...
  describe('.url', () => {
    it('should take correlationId and sessionId out of queryInfo', () => {
      JSON.stringify(thisModel.url()).should.equal(JSON.stringify({
        'uri': 'http://localhost:8001/status/GT1234123/employer/calculate',
        'headers': {
          'sessionid': '1234',
          'correlationid': 'asdf1234'
        }
